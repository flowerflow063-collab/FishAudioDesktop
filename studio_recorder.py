...
class StudioRecorder:
    ...
    def __init__(self, master, status_callback=None):
        ...
        self.layout = master.tk.StringVar(value="horizontal")
        self.output = master.tk.StringVar(value=str(Path.home() / "Videos" / "FlowRecorder" / "flowrecorder.mp4"))
        self.cam_var = master.tk.StringVar(value="Cámara 0")
        self.monitor_var = master.tk.StringVar(value="Monitor 1")
        self.sct = None
        self.monitors = []
        self.cam = None
        self.writer = None
    ...
    def _build(self):
        ...
        self.preview = __import__("tkinter").Label(root, bg="#080b10", fg="#8f9aaa", text="Vista previa\nInicia previsualización", font=("Segoe UI", 16))
